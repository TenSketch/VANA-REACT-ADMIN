  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 px-4 py-3">
      <div className="flex items-center justify-between flex-wrap md:flex-nowrap">
        {/* Left side - Hamburger, Brand, and Breadcrumbs */}
        <div className="flex items-center space-x-4 flex-nowrap overflow-hidden">
          <Button
            variant="ghost"
            size="sm"
            onClick={onMenuClick}
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <span className="text-xl font-semibold text-gray-800 hidden sm:block">Vanavihari Admin</span>
            <span className="text-lg font-semibold text-gray-800 sm:hidden">Vana</span>
          </div>

          {/* Breadcrumb - always show last item in mobile */}
